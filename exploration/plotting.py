...
class CandlePlot:
    ...
    def add_traces_ma(self, line_traces, is_sec=False):
    ...
    def show_plot(self, width=1100, height=600, nticks=5, line_traces=[], sec_traces=[]):
        self.add_traces_ma(line_traces)
        self.add_traces_ma(sec_traces, is_sec=True)
